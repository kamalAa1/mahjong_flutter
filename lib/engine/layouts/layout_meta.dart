...
import '../desktopFileReader/localizable_string.dart';
import '../desktopFileReader/parse_spec.dart';
import '../desktopFileReader/parser.dart';
...
class LayoutMetaCollection {
  ...
  LayoutMeta get(String name) {
    if (!_layouts.containsKey(name)) throw LayoutNotFound(name);
